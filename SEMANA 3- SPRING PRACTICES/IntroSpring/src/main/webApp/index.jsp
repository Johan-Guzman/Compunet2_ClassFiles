...
<%
   ...
   ShopService shopService = (ShopService) AppContext.getInstance().getBean("shopService");

    ArrayList<String> list = shopService.getShopList();
    out.println("<ol>");
...
<form method="POST" action="shop">
    <input type="text" placeholder="Escribe tu compra" name="compra">
